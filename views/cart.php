        ...
        <div class="row">
            <div class="col-md-9">
                <div class="card mb-2">
                    <div class="card-header flex-wrap">
                        ...
                        <h5 class="m-0">รายการสินค้าในตะกร้า</h5>
                    </div>
                    <div class="card-body">
                ...
                <div class="card">
                    <div class="card-header flex-wrap">
                        ...
                        <h5 class="m-0">รายละเอียดข้อมูลที่อยู่</h5>
                    </div>
                    <div class="card-body">
            ...
            <div class="col-md-3">
                <div class="card">
                    <div class="card-header flex-wrap">
                        <span class="float-end"></span>
                        <h5 class="m-0">สรุปรายการทั้งหมด</h5>
                    </div>
                    <div class="card-body">
                        <div class="card-content flex-wrap">
                            ...
                            <h2 class="font-bold float-end">
                                $390,00
                            </h2>

                        </div>
                    </div>
                    <div class="card-footer m-t-sm">
                        <a href="#" class="btn btn-success"><i class="fa fa-shopping-cart"></i> Checkout</a>
