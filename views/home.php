      ...
      <div class="d-flex flex-column flex-md-row align-items-center justify-content-center">
        <div class="m-0 list-group list-group-checkable d-grid gap-2 border-0">
          ...
          <label class="list-group-item list-group-item-action d-flex gap-3 rounded-3 py-3" for="listGroupCheckableRadios1">
            <div class="masthead-followup-icon d-inline-block p-1 text-bg-secondary rounded flex-shrink-0">
...
<div class="container">
  ...
  <div class="row" style="margin-top: 50px;">
    ...
    <div class="col-md-12">
      <h2 class="pb-2 border-bottom">
        <span class="title titleBefore pb-1">Recommended</span>
      </h2>
...
<div class="container">
  <div style="margin-top: 50px;">
    ...
    <h2 class="pb-2 border-bottom">
      <span class="title titleBefore pb-1">Product</span>
    </h2>
