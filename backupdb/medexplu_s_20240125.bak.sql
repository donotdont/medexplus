...
--
-- Host: 127.0.0.1
-- Generation Time: Jan 25, 2024 at 06:05 AM
...
CREATE TABLE `amphure` (
  `id_amphure` int(5) NOT NULL,
  `amphure_code` varchar(4) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `amphure_name_th` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `amphure_name_en` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_province` int(5) DEFAULT 0
...
INSERT INTO `amphure` (`id_amphure`, `amphure_code`, `amphure_name_th`, `amphure_name_en`, `id_province`) VALUES
...
(3, 'Urine Analysis', '2023-12-29 12:29:36', '2024-01-05 21:22:56'),
...
CREATE TABLE `district` (
  `id_district` varchar(6) CHARACTER SET utf8 COLLATE utf8_bin NOT NULL,
  `zip_code` int(11) DEFAULT NULL,
  `district_name_th` varchar(150) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `district_name_en` varchar(150) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL,
  `id_amphure` int(11) DEFAULT 0
...
INSERT INTO `district` (`id_district`, `zip_code`, `district_name_th`, `district_name_en`, `id_amphure`) VALUES
...
CREATE TABLE `geography` (
  `id_geography` int(11) NOT NULL,
  `geography_name` varchar(255) CHARACTER SET utf8 COLLATE utf8_bin DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci COMMENT='InnoDB free: 8192 kB';
...
INSERT INTO `geography` (`id_geography`, `geography_name`) VALUES
(1, 'ภาคเหนือ'),
(2, 'ภาคกลาง'),
...
CREATE TABLE `product` (
  ...
  `product_description_th` text DEFAULT NULL,
...
INSERT INTO `product` (`id_product`, `id_category`, `product_group`, `product_cover`, `product_name`, `product_brand`, `product_description_th`, `product_description_en`, `product_price`, `product_quantity`, `product_status`, `created_at`, `updated_at`) VALUES
(1, 1, '3 - Part Hematology analyzer', '/assets/images/products/dh26/cover.jpg', 'DH26', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 15:22:40'),
(2, 1, '3 - Part Hematology analyzer', '/assets/images/products/dh36/cover.jpg', 'DH36', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 16:19:04'),
(3, 1, '3 - Part Hematology analyzer', '/assets/images/products/dp-h10/cover.jpg', 'DP-H10', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 16:24:23'),
(4, 1, '3 - Part Hematology analyzer', '/assets/images/products/dh20/cover.jpg', 'DH 20', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 16:29:38'),
(5, 1, '5 - Part Hematology analyzer', '/assets/images/products/df50crp/cover.jpg', 'DF50CRP', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 17:21:52'),
(6, 1, '5 - Part Hematology analyzer', '/assets/images/products/dh76/cover.jpg', 'DH76', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 17:25:50'),
(7, 1, '5 - Part Hematology analyzer', '/assets/images/products/un73/cover.jpg', 'UN73', 'dymind', NULL, NULL, NULL, NULL, NULL, '2024-01-05 11:58:43', '2024-01-09 17:28:30');
...
CREATE TABLE `province` (
  ...
  `province_code` varchar(2) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `province_name_th` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `province_name_en` varchar(150) CHARACTER SET utf8 COLLATE utf8_unicode_ci DEFAULT NULL,
  `id_geography` int(5) DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_general_ci;
...
INSERT INTO `province` (`id_province`, `province_code`, `province_name_th`, `province_name_en`, `id_geography`) VALUES
...
--
ALTER TABLE `amphure`
  ADD PRIMARY KEY (`id_amphure`) USING BTREE;
...
ALTER TABLE `geography`
  ADD PRIMARY KEY (`id_geography`) USING BTREE;
...
--
-- AUTO_INCREMENT for table `amphure`
--
ALTER TABLE `amphure`
  MODIFY `id_amphure` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=1007;
...
--
ALTER TABLE `geography`
  MODIFY `id_geography` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
...
--
ALTER TABLE `province`
  MODIFY `id_province` int(5) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=78;
COMMIT;
